...
async function loadProcessors() {
  try {
    const notesModule = await import('../apps/bt-studio/src/services/notes-processor.js');
    const questionsModule = await import('../apps/bt-studio/src/services/questions-processor.js');
    const usfmModule = await import('../apps/bt-studio/src/services/usfm-processor.js');
