...
export function demonstrateMultimediaUtilities() {
  console.log('=== Multimedia Label Utilities Demo ===');
  ...
  console.log('Text from text label:', getDisplayText(textLabel));
  console.log('Text from image label:', getDisplayText(imageLabel));
  console.log('Text from audio label:', getDisplayText(audioLabel));
  
  console.log('Image label has image?', hasMediaType(imageLabel, 'image'));
  console.log('Audio label has text?', hasMediaType(audioLabel, 'text'));
  
  // Validate content
  const validation = validateMediaContent(imageLabel.primary);
  console.log('Image content validation:', validation);
  ...
  console.log('Combined label text:', getDisplayText(combinedLabel));
  console.log('Combined label has audio?', hasMediaType(combinedLabel, 'audio'));
  console.log('Audio content from combined:', getMediaContent(combinedLabel, 'audio'));
}
