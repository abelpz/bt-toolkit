/**
 * Versification Data - Iteration 2
 * Chapter and verse structure for all biblical books
 * Based on LXX versification from Copenhagen Alliance
 * Source: https://raw.githubusercontent.com/Copenhagen-Alliance/versification-specification/refs/heads/master/versification-mappings/standard-mappings/lxx.json
 */

export interface BookVersification {
  code: string;
  name: string;
  testament: 'OT' | 'NT';
  chapters: number[];
...
// Versification data based on LXX standard
export const VERSIFICATION_DATA: Record<string, BookVersification> = {
  // Old Testament
  'gen': {
    code: 'gen',
    name: 'Genesis',
  ...
  'exo': {
    ...
    name: 'Exodus',
    testament: 'OT',
    chapters: [22, 25, 22, 31, 23, 30, 29, 28, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26, 37, 30, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 21, 27, 23, 38]
  },
  'lev': {
    code: 'lev',
    name: 'Leviticus',
  ...
  'num': {
    ...
    name: 'Numbers',
    testament: 'OT',
    chapters: [54, 34, 51, 49, 31, 26, 89, 26, 23, 36, 35, 16, 33, 45, 41, 35, 28, 32, 22, 29, 35, 41, 30, 25, 18, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13]
  },
  'deu': {
    code: 'deu',
    name: 'Deuteronomy',
  ...
  'jos': {
    ...
    name: 'Joshua',
    testament: 'OT',
    chapters: [18, 24, 17, 24, 15, 27, 26, 29, 27, 42, 23, 24, 32, 15, 63, 10, 18, 28, 51, 9, 45, 34, 16, 33]
  },
  'jdg': {
    code: 'jdg',
    name: 'Judges',
  ...
  '1sa': {
    ...
    name: '1 Samuel',
    testament: 'OT',
    chapters: [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 54, 29, 24, 42, 16, 23, 28, 23, 44, 25, 12, 25, 11, 31, 13]
  },
  '2sa': {
    code: '2sa',
    name: '2 Samuel',
  ...
  '1ki': {
    ...
    name: '1 Kings',
    testament: 'OT',
    chapters: [53, 46, 28, 19, 32, 36, 50, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 29, 43, 54]
  },
  '2ki': {
    code: '2ki',
    name: '2 Kings',
  ...
  'neh': {
    ...
    name: 'Nehemiah',
    testament: 'OT',
    chapters: [11, 20, 37, 23, 19, 19, 73, 18, 38, 40, 36, 47, 31]
  },
  'est': {
    code: 'est',
    name: 'Esther',
  ...
  'psa': {
    ...
    name: 'Psalms',
    testament: 'OT',
    chapters: [6, 12, 9, 9, 13, 11, 18, 10, 39, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32, 6, 10, 22, 12, 14, 9, 11, 13, 25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5, 27, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 14, 12, 12, 18, 14, 9, 13, 12, 11, 14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13, 14, 17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 8, 12, 15, 21, 10, 20, 14, 9, 6]
  },
  'pro': {
    code: 'pro',
    name: 'Proverbs',
  ...
  'dan': {
    ...
    name: 'Daniel',
    testament: 'OT',
    chapters: [21, 49, 100, 34, 30, 29, 28, 27, 27, 21, 45, 13]
  },
  'hos': {
    code: 'hos',
    name: 'Hosea',
  ...
  // New Testament (using standard versification)
  'mat': {
    code: 'mat',
    name: 'Matthew',
    testament: 'NT',
  ...
  'rev': {
    ...
    name: 'Revelation',
    testament: 'NT',
    chapters: [20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 18, 18, 20, 8, 21, 18, 24, 21, 15, 27, 21]
  }
};

// Helper functions
export const getBookVersification = (bookCode: string): BookVersification | null => {
  return VERSIFICATION_DATA[bookCode] || null;
};

export const getChapterVerseCount = (bookCode: string, chapter: number): number => {
...
export const getTotalChapters = (bookCode: string): number => {
  const book = getBookVersification(bookCode);
  return book ? book.chapters.length : 0;
};

export const getAllBooks = (): BookVersification[] => {
  return Object.values(VERSIFICATION_DATA);
};

export const getBooksByTestament = (testament: 'OT' | 'NT'): BookVersification[] => {
  return Object.values(VERSIFICATION_DATA).filter(book => book.testament === testament);
};
